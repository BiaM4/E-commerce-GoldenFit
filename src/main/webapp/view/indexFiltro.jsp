...
<%
  ...
  System.out.println("aa "+ produtos);
%>
<body>
    ...
    <div class="d-flex flex-row mb-3" style="justify-content: center; align-items: center;">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="view/listaClientes.jsp">Meu perfil</a></li>
...
<img src="view/images/banner.png" style="height: 60%; width: 100%; flex: 1px " >
<div style="margin-top: 15px">
  <H3 style="color:#000000 ; font-size: 20px; text-align: center;"> <strong>Produtos</strong></H3>

  <div style="background-color: #ECBD69; height: 5px; margin-bottom: 1%; margin-left: 2.5%; margin-right: 2.5%"></div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div style=" margin-top: 30px; margin-bottom: 50px ">
          <img src="view/images/<%=produto.getLinkImagem() %>" style="height: 200px; width: 200px; margin-bottom: 1%">
          <a href="/GoldenFit_war/controlador?acao=consultar&viewHelper=ConsultarProdutoVH&id=<%=produto.getId()%>"
             style="text-decoration: none;">
            <div style="background-color: #173B21; height: 90px; width: 200px; padding: 10px;">
  ...
  <div class="chatbot-icon-container">
    <div class="chatbot-icon-circle">
      <a href="view/chatbot.jsp">
        <img class="chatbot-icon" src="view/images/bate-papo.png" alt="Ícone do Chatbot">
      </a>
    </div>
  </div>
</div>
