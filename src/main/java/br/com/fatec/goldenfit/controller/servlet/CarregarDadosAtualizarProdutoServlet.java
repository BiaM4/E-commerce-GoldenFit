...
@WebServlet("/view/carregarDadosAtualizarProduto")
public class CarregarDadosAtualizarProdutoServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/view/atualizarProduto.jsp");
