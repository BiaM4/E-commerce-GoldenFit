...
@WebServlet("/view/consultarDadosProduto")
public class ConsultarDadosProdutoServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/view/consultarProdutos.jsp");
