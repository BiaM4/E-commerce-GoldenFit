...
@WebServlet("/view/carregarTodosProdutos")
public class ListarTodosProdutosServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/view/movimentacoes.jsp");
