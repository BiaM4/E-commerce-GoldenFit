...
@WebServlet("/view/carregarTodosProdutosAtualizados")
public class ListarTodosProdutosAtualizadosServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/controlador?acao=consultar&viewHelper=ConsultarProdutosVH");
